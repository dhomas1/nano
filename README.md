...
Check the [releases](https://github.com/droboports/nano/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/nano.git
cd nano
./build.sh
ls -la *.tgz
```
