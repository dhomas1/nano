...
Check the [releases](https://github.com/dhomas1/nano/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/dhomas1/nano.git
cd nano
./build.sh
ls -la *.tgz
```
